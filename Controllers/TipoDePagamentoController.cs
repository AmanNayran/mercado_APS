...
namespace AmanNayran.Controllers
{
    public class TipoDePagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoDePagamentoId,FormaDePagamento,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoDePagamentoId,FormaDePagamento,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
        ...
        {
            return _context.TiposDePagamento.Any(e => e.TipoDePagamentoId == id);
        }
    }
}
